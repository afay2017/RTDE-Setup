...
class URRobot(object):
    ...
    def servoj(self, joints, t=0.008, lookahead_time=0.1, gain=300):
        """
        servo in joint space
        """
        prog = self._format_servo("servoj", joints, t, lookahead_time, gain)
        self.send_program(prog)
    ...
    def _format_servo(self, command, tpose, t=0.008, lookahead_time=0.1, gain=300, prefix=""):
        tpose = [round(i, self.max_float_length) for i in tpose]
        tpose.append(t)
        tpose.append(lookahead_time)
        tpose.append(gain)
        return "{}({}[{},{},{},{},{},{}], t={}, lookahead_time={}, gain={})".format(command, prefix, *tpose)
